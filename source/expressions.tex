...
\nontermdef{lambda-declarator}\br
    decl-specifier-seq \opt{noexcept-specifier} \opt{attribute-specifier-seq} \opt{trailing-return-type}\br
    noexcept-specifier \opt{attribute-specifier-seq} \opt{trailing-return-type}\br
    \opt{trailing-return-type}\br
    \terminal{(} parameter-declaration-clause \terminal{)} \opt{decl-specifier-seq} \opt{noexcept-specifier} \opt{attribute-specifier-seq}\br
